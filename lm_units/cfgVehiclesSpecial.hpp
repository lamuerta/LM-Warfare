...
class LM_SPECIAL_HELIPILOTE : LM_SPECIAL_MAN
{
	...
	linkedItems[] = {"H_PilotHelmetHeli_B", "ItemMap", "ItemCompass", "tf_microdagr", "tf_anprc152"};
	respawnLinkedItems[] = {"H_PilotHelmetHeli_B", "ItemMap", "ItemCompass", "tf_microdagr", "tf_anprc152"};
	magazines[] = {};
	respawnMagazines[] = {};
};
...
class LM_SPECIAL_PILOTE : LM_SPECIAL_MAN
{
	...
	items[] = {KSI, "ACE_MapTools"};
	respawnItems[] = {KSI, "ACE_MapTools"};
	linkedItems[] = {"H_PilotHelmetFighter_B", "ItemMap", "ItemCompass", "tf_microdagr", "tf_anprc152", "ItemGPS"};
	respawnLinkedItems[] = {"H_PilotHelmetFighter_B", "ItemMap", "ItemCompass", "tf_microdagr", "tf_anprc152", "ItemGPS"};
...
class LM_SPECIAL_TANKPILOTE : LM_SPECIAL_MAN
{
	...
	items[] = {KSI};
	respawnItems[] = {KSI};
	linkedItems[] = {"VSM_CarrierRig_Operator_AOR1", "H_HelmetCrew_B", "G_Tactical_Clear", "tf_microdagr", "tf_anprc152"};
	respawnLinkedItems[] = {"VSM_CarrierRig_Operator_AOR1", "H_HelmetCrew_B", "G_Tactical_Clear", "tf_microdagr", "tf_anprc152"};
	magazines[] = {};
	respawnMagazines[] = {};
};
...
class LM_SPECIAL_SPOTTER : LM_SPECIAL_MAN
{
	...
	linkedItems[] = {"VSM_CarrierRig_Gunner_AOR1", "VSM_Bowman_cap_Tan", "tf_microdagr", "tf_anprc152", "ItemMap", "ItemCompass", "NVGoggles"};
	respawnLinkedItems[] = {"VSM_CarrierRig_Gunner_AOR1", "VSM_Bowman_cap_Tan", "tf_microdagr", "tf_anprc152", "ItemMap", "ItemCompass", "NVGoggles"};
...
class LM_SPECIAL_SNIPER : LM_SPECIAL_MAN
{
	...
	linkedItems[] = {"VSM_CarrierRig_Gunner_AOR1", "VSM_Bowman_cap_Tan", "tf_microdagr", "tf_anprc152","NVGoggles"};
	respawnLinkedItems[] = {"VSM_CarrierRig_Gunner_AOR1", "VSM_Bowman_cap_Tan", "tf_microdagr", "tf_anprc152", "NVGoggles"};
